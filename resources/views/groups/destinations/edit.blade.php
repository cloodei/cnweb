<x-app-layout>
    <x-slot name="header">
        <div class="flex items-start gap-4">
            ...
            <div>
                ...
                <h1 class="section-title mt-2">Sửa địa điểm riêng</h1>
                <p class="section-subtitle">{{ $groupLocation->name }}</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="page-shell space-y-6">
        ...
        <form action="{{ route('groups.destinations.update', [$group, $groupLocation]) }}" method="POST" class="grid gap-6 xl:grid-cols-[0.52fr_0.48fr]">
            @csrf
            @method('PUT')
            ...
            <section class="surface-panel p-6 sm:p-8">
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $groupLocation->name) }}" class="field-control" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="address" id="address" value="{{ old('address', $groupLocation->address) }}" class="field-control">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="field-control">{{ old('description', $groupLocation->description) }}</textarea>
            ...
            <aside class="surface-panel h-fit p-5 sm:p-6 xl:sticky xl:top-24">
                @include('groups.destinations.partials.place-picker', ['googleMapsKey' => $googleMapsKey, 'groupLocation' => $groupLocation])
            </aside>
        </form>
    </div>
</x-app-layout>
